...
- [ ] Hetzner CX43 (Phase A, 8 vCPU / 16 GB / 160 GB NVMe / ~€14/mo — replaces the pre-Apr-2026 CX32 reference per research doc 36) OR Iranian DC (SamplePlatform) — Phase 9 dogfoods on real Hetzner; Phase 10 P1 cuts over SamplePlatform. Phase 8 validated the install on `docker run ubuntu:24.04` throwaway + local CH only.
...
- [ ] Hetzner CX43 (~€14/mo, 8 vCPU / 16 GB / 160 GB NVMe / 20 TB traffic / Falkenstein, post-Apr-2026 rename of the old CX32 — see research doc 36) as D1 initial. Upgrade to AX42 at ~10 SaaS customers (Phase C).
...
**Server costs:** Hetzner CX43 (~€14/mo, 8 vCPU / 16 GB / 160 GB NVMe — renamed from CX32 per Apr-2026 Hetzner rename, research doc 36) Phase A dogfood → AX41 (~€39/mo) first ~10 paying → AX42 (€46/mo) ~30–50 customers → AX102 (€104/mo) 100+. SamplePlatform Iranian DC ~€180/mo (quote-based; phase-dependent per [`deployment.md § Server Costs`](docs/deployment.md#server-costs)).
...
|---|---|---|---|---|
| **D1 — `statnive.live` (SaaS)** | Hetzner CX43 (v1, post-Apr-2026 rename of CX32) → AX41/AX42 | Multi-tenant, pooled CH | Dogfood + public SaaS | A, C |
