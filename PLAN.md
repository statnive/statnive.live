...
- [ ] Hetzner CX32 (Phase A) OR Iranian DC (SamplePlatform) — Phase 9 dogfoods on real Hetzner; Phase 10 P1 cuts over SamplePlatform. Phase 8 validated the install on `docker run ubuntu:24.04` throwaway + local CH only.
